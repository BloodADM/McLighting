...
.tap-target-wrapper.open .tap-target-wave::after{visibility:visible;-webkit-animation:pulse-animation 1s cubic-bezier(0.24, 0, 0.38, 1) infinite;animation:pulse-animation 1s cubic-bezier(0.24, 0, 0.38, 1) infinite;-webkit-transition:opacity .3s,
 ...
 visibility 0s 1s, -webkit-transform .3s;transition:opacity .3s, transform .3s,
...
<body>
  <nav class="grey" role="navigation">
    <div class="nav-wrapper container">
      <a id="logo-container" href="#" class="brand-logo">S6C5</a>
    </div>
  </nav>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col s6">
        <h5>Segmenty <a href="#" onclick="addSegment(event)"><i class="material-icons">add_box</i></a></h5>
        <ul id="segmentList" class="collection"></ul>
      </div>

      <div class="col s6">
        <h6>Zasięg segmentu</h6>
        <div id="rangeSlider"></div><br>
        <h6>Prędkość segmentu</h6>
  ...
  <footer class="grey page-footer">
    <div class="grey footer-copyright">
      <div class="container">
        Stworzone przez <a class="black-text" href="https://anweb.pl">Anweb.pl</a>
      </div>
    </div>
  </footer>
